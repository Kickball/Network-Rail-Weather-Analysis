...
nrWeatherIncident <- read.csv("C:\\Users\\Edward\\OneDrive\\Documents\\University\\4th Year\\Dissertation (BMAN31260)\\Data\\Network Rail Incidents\\National Rail - Weather Incident Export.csv", stringsAsFactors = FALSE, na.strings = c("", "#N/A", "NA", "N/A"))
